...
document.addEventListener('DOMContentLoaded', () => {
    ...
    options.forEach(option => {
        option.addEventListener('click', () => {
            ...
            options.forEach(opt => {
                opt.classList.remove('border-2', 'border-primary', 'bg-surface-container-high');
                opt.classList.add('border', 'border-outline-variant');
            });
            // Add selection to clicked
            option.classList.remove('border', 'border-outline-variant');
            option.classList.add('border-2', 'border-primary', 'bg-surface-container-high');
        });
    });
});
